...
IRC: #ansible-meeting
IRC Meeting log link: (please post afterwards)
PLEASE LINK YOUR NAME TO A COLOR in the sidebar!
...
Action plugins
Discussion
Do we need a simple example
plus
Something that shows how to do the complex bits like how to setup environment
